...
Route::group([
    ...
    Route::get('test3','MatchController@column_update');
    ...
    Route::get('alltournament','TournamentController@alltournament'); 
    Route::get('alltournamentnew','TournamentController@alltournamentnew'); 
    Route::post('alltournamentcontest','ContestController@TournmentContest_list');  
    Route::post('mytournament','TournamentController@mytournament');

    Route::post('createTournmentTeam', 'TournamentController@createTeam'); 
    Route::post('savetournamentheros', 'TournamentController@saveTournmentTeam'); 

    Route::post('mytournamentteamdetails','TournamentController@mytournamentdetails');
    ...
    Route::group(['middleware' => 'auth:api'], function(){
            ...
            //  ********************
        Route::post('heroslist', 'HerosController@playerlist');
        Route::post('saveheros', 'HerosController@saveheros');
        ...
        Route::post('depositresponse', 'CashfreeController@depositresponse');
        ...
        Route::post('myteamdetails', 'MatchController@myteamdetails'); 
        Route::post('myteamdetailsnew', 'MatchController@myteamdetailsnew'); 
        ...
        Route::post('jointournamentcontest','ContestController@jointournamentcontest');
