...
extract($_POST);
    $secretKey = 'b9bdf5bffd470e5d06492dacf8bb66f3ed670603';
    $appId = '10554101503d1cfca147fe23645501';
    $orderId = 'order000011';
    $orderAmount = '100';
    $orderCurrency = 'INR';
    $orderNote = 'test';
    $customerName  = 'vignesh';
    $customerPhone ='8124319818';
    $customerEmail = 'vignesh.pixelweb@gmail.com';
    $returnUrl = 'https://fantasy.demozab.com/response';
    $notifyUrl = 'https://fantasy.demozab.com/response';
...
// $signature = 'FjX+4BJgyNewv62RxBztMkml0E2z5z+Gml5q41ObUiM=';
