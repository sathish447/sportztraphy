    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        ...
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#">USER LIST</a>
        <!-- Form -->
    ...
    <tr>
      ...
      <td>  @if($user->phone_verify == 1) Yes @elseif($user->phone_verify == 2) Waiting @else No @endif </td> --}}
       ...
       <!--  <td id="{{ $user->id }}">
        ...
        <td class="text-left">
          <a href="{{ url('/admin/users_edit/'.Crypt::encrypt($user->id)) }}" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="View"><i class="far fa-eye"></i></a>
          <a href="{{ url('/admin/user_excel/'.Crypt::encrypt($user->id)) }}" class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Export"><i class="fas fa-download"></i></a>
          @if($user->status == 1) 
          <a class="btn btn-sm btn-danger" onclick="changestatus('disable','{{ $user->id }}')" href="#" data-toggle="tooltip" data-placement="top" title="Deactivate"><i class="fas fa-user-times"></i></a>
          @else 
          <a class="btn btn-sm btn-success"  onclick="changestatus('enable','{{ $user->id }}')" href="#" data-toggle="tooltip" data-placement="top" title="Activate"><i class="fas fa-user-check"></i></a>
          @endif
      </td>
