...
<div class="container-fluid mt--7">
 ...
 @endif
    ...
    <form class="form-horizontal site-form" method="POST" action="{{ url('/admin/savefaq') }}" autocomplete="off">
     ...
     {{ csrf_field() }}
        ...
        <div class="form-group row">
            ...
            <div class="div-input">
              <textarea required class="ckeditor" rows="3" cols="30" id="textarea" name="question"> {{ old('question') }}</textarea>
        ...
        <div class="form-group row">
          ...
          <div class="div-input">
            <textarea required class="ckeditor" rows="3" cols="30" id="textarea" name="answer"> {{ old('answer') }}</textarea>
            @if ($errors->has('contest_name'))
                <span class="help-block">
