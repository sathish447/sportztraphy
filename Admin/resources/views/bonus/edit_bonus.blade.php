...
<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
  <div class="container-fluid"> 
     <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#"> EDIT BONUS </a> 
     ...
     @endif
          ...
          <form method="post"  action="{{ url('admin/create_bonus') }}">
            ...
            <div class="form-group row">
              ...
              <div class="div-input">
                <input class="form-control" type = "number" required="required" name="referal_bonus" value="{{old('referal_bonus')}}" >
            ...
            <div class="form-group row">
              ...
              <div class="div-input">
               <input class="form-control" type = "number" id="joined_bonus" required="required" name="joined_bonus" value="{{old('joined_bonus')}}">
