...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<a href="{{ url('admin/bank') }}"><i class="zmdi zmdi-arrow-left"></i> Back to Company Bank Details</a>
					<br /><br />  
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group {{ $errors->has('coin') ? ' has-error' : '' }}">
									...
									<input  class="form-control" type="text" name="coin" required="required" value="">
									@if ($errors->has('coin'))
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group {{ $errors->has('company_bank') ? ' has-error' : '' }}">
									<textarea rows="5" required="required" cols="50" name="company_bank" class="form-control textarea-class"></textarea>
