...
<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
  <div class="container-fluid"> 
     <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#"> UPDATE CONTACT US CONTENT </a> 
  ...
  <div class="container-fluid">
    ...
    <div class="container-fluid mt--7"> 
      <div class="row">
        ...
        @endif
          <form method="post" action="{{url('admin/create_contact')}}">
            {{ csrf_field() }}
            <div class="form-group row">
              ...
              <div class="div-input editor">
               <input type="hidden" name="type" value="contactus">
                    <textarea id="messageArea" name="content" rows="7" class="form-control ckeditor" placeholder="Write your message..">{{@$contact_details->content}}</textarea>
              </div>
            </div>
